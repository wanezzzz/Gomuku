...
let Model = function (width, height, AILevel, firstMove) {
    ...
    this.isWin = function (x, y) {
        let i1 = x - this.row >= 0 ? x - this.row : 0;
        let i2 = y - this.row >= 0 ? y - this.row : 0;
        let height = y + this.row < this.height ? y + this.row : this.height -1;
